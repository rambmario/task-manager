...
Public Class frmReporteTareasEntreFechas

    Private Sub frmReporteTareasEntreFechas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case parametro_reporte
            Case "porEmpresa"
                consulta = 1
                rpt.Load(PathReporte & "rptTareasEntreFechas.rpt")
            Case "porProyecto"
                consulta = 2
                rpt.Load(PathReporte & "rptTareasEntreFechas.rpt")
            Case "porSubproyecto"
        ...
        odt = oTarea.GetEntreFecha(parametro_fecha_inicio, parametro_fecha_fin, parametro_id_empresa, parametro_id_proyecto, parametro_id_subproyecto, consulta)
