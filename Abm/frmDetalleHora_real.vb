Public Class frmDetalleHora_real
    ...
    Private Sub frmDetalleHora_real_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If BanderaHora_real = 1 Then
            Me.LimpiarControles()
            'Me.lblid_usuario_asignado.Text = CType(Me.Owner, frmDetalleTarea_2).lblid_usuario_asignado.Text

            Me.lblid_usuario_asignado.Text = frmDetalleTarea_2.lblid_usuario_asignado.Text
            Me.cmbusuario_asignado.Text = oUsuario.GetOne(CInt(Me.lblid_usuario_asignado.Text)).Rows(0).Item("identificador").ToString.Trim
        End If
    ...
    Private Sub ObtenerDatos()
        'Me.lblid_tarea.Text = CType(Me.Owner, frmDetalleTarea_2).lblid_tarea.Text
        Me.lblid_tarea.Text = frmDetalleTarea_2.lblid_tarea.Text
        ...
        Try
            ...
            Select Case BanderaHora_real
                Case 1 'GUARDA,REFRESCA LA GRILLA E INSERTA UNO NUEVO (AGREGAR)
                    oHora_real.Guardar()
                    'CType(Me.Owner, frmDetalleTarea_2).RefrescarHora_real()

                    frmDetalleTarea_2.RefrescarHora_real()
